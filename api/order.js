...
export function getExpress() {
  return request.get("order/getexpress");
}
/**
 * 修改购物车数量
 ...
 * @param object data
*/
export function lootorderPay(q, types) {
  return request.get("create_loot_order", q);
}
...
export function lootOrderData(){
  return request.get('order/lootnumber')
}
...
// 待开奖夺宝
export function groupLootList(data) {
	return request.get("order/group_loot_list",data,{ noAuth : true });
}
