 ...
 * @param data object 
 */
export function hz(data) {
  return request.post("auth/hz", data, { noAuth : true });
}
/**
 * 验证码key
 */
...
export function getRecommentAccount(data) {
  return request.post("auth/getRecommentAccount", data, { noAuth : true });
}
export function agreeys(data) {
  return request.post("auth/agreeys", data, { noAuth : true });
}
...
export function getMoneyConfig(q, types) {
  return request.get("money_config", q);
}
export function createMoneyOrder(q, types) {
  return request.get("create_money_order", q);
}
export function getMoneyOrderData(q, types) {
  return request.get("get_money_order_data", q);
}

export function getMoneyOrderList(q, types) {
  return request.get("money_order_list", q);
}
export function opMoneyOrder(q, types) {
  return request.get("op_money_order", q);
}
export function getercodepay(q, types) {
  return request.get("get_ercode_pay", q);
}
export function editpwd(q, types) {
  return request.get("editpwd", q);
}
export function editpaypwd(q, types) {
  return request.get("editpaypwd", q);
}

export function upercodepay(data) {
  return request.get("up_ercode_pay", {...data});
}
export function getercodepaysell(q, types) {
  return request.get("get_ercode_pay_sell", q);
}
export function upercodepaybuy(data) {
  return request.get("up_ercode_pay_buy", {...data});
}
export function getercodepayconfrim(q, types) {
  return request.get("get_ercode_pay_confrim", q);
}
export function authPayPwd(q, types) {
  return request.get("auth_pay_pwd", q);
}
