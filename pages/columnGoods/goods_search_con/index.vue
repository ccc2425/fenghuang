		...
		<view class='productList'>
			...
			<view class="nav-wrapper">
				...
				<block v-if="tabIndex==2">
					<view class='nav acea-row row-middle'>
						<view class='item' :class="{'font-color':storeKey == 0}" @click="storeTab(0)">
							综合排序
						</view>
						<view class='item' @click="storeTab(1)" :class="{'font-color':storeKey == 1}">
							销量排序
						</view>
						<view class='item' @click="storeTab(2)" :class="{'font-color':storeKey == 2}">
							信用
						</view>
					</view>
				</block>
