		...
		<form @submit="submitSub" report-submit='true'>
            ...
            <view :hidden="userFeedbackHidden" class="popup_content">
                ...
                <view class="popup_textarea_item">
                    ...
                    <input class="inpit zfpass" type="text" v-show="!flag2" placeholder="请输入支付安全码" value="" v-model="zfpass" style="margin-top: 13px;"/>
                    <div class="item" v-show="!flag1"  style="position: relative;">
                                        	<div class="acea-row row-middle">
                                        		<input type="text"  placeholder="填写验证码" class="codeIput" v-model="captcha" style="     height: 40px;
                    ...
                    width: 100%;
                        ...
                        "
                    />
                    <button v-if="isShowCode" style="    position: absolute;
                        width: 75px;
                        height: 25px;
                        ...
                        font-size: 12px;" class="code" >
                                        			{{content}}
                                        		</button>
                                        		<button v-else style="    position: absolute;
                    width: 75px;
                    height: 25px;
                    ...
                    right: 0;
                        ...
                        right: 3%;
                        top: 20px;
                    font-size: 12px;" class="code"  @click="code">
                                        			获取验证码
                                        		</button>
                                        	</div>
                                        </div>
					<div class='aqm' style="margin-top: 5px;background: #1ABB1D;width: 120px;padding: 3px 2px;text-align: center;color:#fff;border-radius: 5px;" v-show="!flag1" @click="qh(1)">点击切换安全码</div>
					<div class="yzm" style="margin-top: 5px;background: #1ABB1D;width: 120px;padding: 3px 2px;text-align: center;color:#fff;border-radius: 5px;" v-show="!flag2" @click="qh(2)">点击切换验证码</div>
	...
	export default {
		...
		methods: {
            ...
            countDown () {
             ...
             this.totalTime = 60
             this.content = '剩余'+this.totalTime+ 's' //这里解决60秒不见了的问题
