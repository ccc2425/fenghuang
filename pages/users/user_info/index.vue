		...
		<form @submit="formSubmit" report-submit='true'>
			<view class='personal-data'>
				...
				<view class='list'>
					...
					<view class='item acea-row row-between-wrapper'>
						<view>服务协议</view>
					    <navigator url="/pages/users/xy/fwxy" class='input acea-row row-between-wrapper ri-my'>点击查看</navigator>
					</view>
					<view class='item acea-row row-between-wrapper'>
						<view>隐私政策</view>
					    <navigator url="/pages/users/xy/yszc" class='input acea-row row-between-wrapper ri-my'>点击查看</navigator>
					</view>
					<!-- #ifdef MP -->
					<view class='item acea-row row-between-wrapper'>
						<view>权限设置</view>
