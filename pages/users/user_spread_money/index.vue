								...
								<view class='itemn acea-row row-between-wrapper'>
									<view>
										<block v-if="item.status>=0">
											<view class='name line1' v-if="item.extract_type == 0">贡献值</view>
											<view class='name line1' v-if="item.extract_type == 1">贡献值</view>
											<view class='name line1' v-if="item.extract_type == 2">贡献值</view>
										</block>
										<block v-else>
